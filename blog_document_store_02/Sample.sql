...
-- TABLE: get all customers which bought 'Product One' and the price they payed
...
-- COLLECTION: get all customers which bought 'Product One' and the price they payed
